...
enum class EEnemyMovementStatus : uint8
{
	...
	EMS_Attack			UMETA(DisplayName = "Attacking"),
...
public:	
	...
	UFUNCTION()
	virtual void AggroSphereOnOverlapBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex,
