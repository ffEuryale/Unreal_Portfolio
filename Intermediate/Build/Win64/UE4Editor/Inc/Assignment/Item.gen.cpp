...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_Mesh_MetaData[] = {
		{ "Category", "Item | Mesh" },
		{ "Comment", "// ?\xe2\xba\xbb ?\xde\xbd? ????\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "?\xe2\xba\xbb ?\xde\xbd? ????" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_CollisionVolume_MetaData[] = {
		...
		{ "Comment", "// ?\xe2\xba\xbb ?\xe6\xb5\xb9 ????\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "?\xe2\xba\xbb ?\xe6\xb5\xb9 ????" },
	};
#endif
	...
	IMPLEMENT_CLASS(AItem, 1349939899);
	template<> ASSIGNMENT_API UClass* StaticClass<AItem>()
	{
		return AItem::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AItem(Z_Construct_UClass_AItem, &AItem::StaticClass, TEXT("/Script/Assignment"), TEXT("AItem"), false, nullptr, nullptr, nullptr);
