...
#include "Assignment/MainPlayerController.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	...
	ASSIGNMENT_API UClass* Z_Construct_UClass_AMainPlayerController();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMainPlayerController_Statics::NewProp_HUDOverlayAsset_MetaData[] = {
		{ "Category", "Widgets" },
		{ "Comment", "// ?????\xcd\xbf??? UMG ???\xdb\xb7????? ????\n" },
		{ "ModuleRelativePath", "MainPlayerController.h" },
		{ "ToolTip", "?????\xcd\xbf??? UMG ???\xdb\xb7????? ????" },
	};
#endif
	...
	IMPLEMENT_CLASS(AMainPlayerController, 1331879579);
	template<> ASSIGNMENT_API UClass* StaticClass<AMainPlayerController>()
	{
		return AMainPlayerController::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMainPlayerController(Z_Construct_UClass_AMainPlayerController, &AMainPlayerController::StaticClass, TEXT("/Script/Assignment"), TEXT("AMainPlayerController"), false, nullptr, nullptr, nullptr);
