...
#include "Assignment/FloorSwitch.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	ASSIGNMENT_API UClass* Z_Construct_UClass_AFloorSwitch_NoRegister();
	ASSIGNMENT_API UClass* Z_Construct_UClass_AFloorSwitch();
...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_InitSwitchLocation_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_InitSwitchLocation;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_InitDoorLocation_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_InitDoorLocation;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloorSwitch_Statics::NewProp_InitSwitchLocation_MetaData[] = {
		{ "Category", "Floor Switch" },
		{ "Comment", "// ?? ????\xc4\xa1 ??\xc4\xa1 ?\xca\xb1?\xc8\xad\n" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
		{ "ToolTip", "?? ????\xc4\xa1 ??\xc4\xa1 ?\xca\xb1?\xc8\xad" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AFloorSwitch_Statics::NewProp_InitSwitchLocation = { "InitSwitchLocation", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFloorSwitch, InitSwitchLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_AFloorSwitch_Statics::NewProp_InitSwitchLocation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFloorSwitch_Statics::NewProp_InitSwitchLocation_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloorSwitch_Statics::NewProp_InitDoorLocation_MetaData[] = {
		{ "Category", "Floor Switch" },
		{ "Comment", "// ?? ??\xc4\xa1 ?\xca\xb1?\xc8\xad\n" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
		{ "ToolTip", "?? ??\xc4\xa1 ?\xca\xb1?\xc8\xad" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AFloorSwitch_Statics::NewProp_InitDoorLocation = { "InitDoorLocation", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFloorSwitch, InitDoorLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_AFloorSwitch_Statics::NewProp_InitDoorLocation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFloorSwitch_Statics::NewProp_InitDoorLocation_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloorSwitch_Statics::NewProp_Door_MetaData[] = {
		...
		{ "Comment", "// ?\xc3\xb7\xce\xbe? ????\xc4\xa1?? ?????? ?? ?\xcc\xb5? ?? ??\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
		{ "ToolTip", "?\xc3\xb7\xce\xbe? ????\xc4\xa1?? ?????? ?? ?\xcc\xb5? ?? ??" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloorSwitch_Statics::NewProp_FloorSwitch_MetaData[] = {
		{ "Category", "FloorSwitch" },
		{ "Comment", "//\xc4\xb3???\xcd\xb0? ???? ?? ?\xd6\xb0? ??\xc8\xaf\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
		{ "ToolTip", "\xc4\xb3???\xcd\xb0? ???? ?? ?\xd6\xb0? ??\xc8\xaf" },
	};
#endif
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFloorSwitch_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFloorSwitch_Statics::NewProp_InitSwitchLocation,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFloorSwitch_Statics::NewProp_InitDoorLocation,
	...
	IMPLEMENT_CLASS(AFloorSwitch, 4062866983);
	template<> ASSIGNMENT_API UClass* StaticClass<AFloorSwitch>()
	{
		return AFloorSwitch::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AFloorSwitch(Z_Construct_UClass_AFloorSwitch, &AFloorSwitch::StaticClass, TEXT("/Script/Assignment"), TEXT("AFloorSwitch"), false, nullptr, nullptr, nullptr);
